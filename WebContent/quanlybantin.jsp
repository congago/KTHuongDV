...
<body>
	...
	<div class="container text-center">
		...
		<div class="row">
			<h3 align="left">
				<span class="glyphicon glyphicon-briefcase"></span> Quản lý bản tin <span class="Success Label"></span>
			</h3>
			<br>
		</div>
        <div class="row">
					...
					<tbody>
						<tr>
							...
							<td align="left">- Tư vấn, chăm sóc, giới thiệu sản phẩm cho khách hàng
                                ...
                                <th ><a href="DA_duyettin?ID=&key=0" role="button" class="btn btn-success"> Duyệt </a>
                                     <a href="DA_xoatin?ID=&key=0" role="button" class="btn btn-danger">Xóa</a></th>
						</tr>
						<tr>
							<td align="left">2</td>
							<td align="left">ABC</td>
