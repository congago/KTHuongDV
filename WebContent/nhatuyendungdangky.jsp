  ...
  <h3 align="left"><span class="glyphicon glyphicon-briefcase"></span>  Nhà tuyển dụng đăng ký <span class = "Success Label"></span></h3>
    <br>
     ...
     <h4>Thông tin công ty</h4>
      ...
      <div class="col-sm-3">
       <h4 align="left">Tên công ty</h4>
     </div>
      <div class="col-sm-3">
        <input class="form-control" placeholder="nhập tên công ty của bạn" id="inputdefault" type="text">
     </div>
      <div class="col-sm-3">
     </div>
      <br>
      ...
      <div class="col-sm-3">
        <input class="form-control" placeholder="nhập địa chỉ của bạn" id="inputdefault" type="text">
     </div>
      <div class="col-sm-3">
     </div>
      <br>
      ...
      <div class="col-sm-3">
       <h4 align="left">Tỉnh / Thành phố</h4>
     </div>
      <div class="col-sm-3">
        <div class="form-group">
         <select name="city" id="city" class="form-control">
      ...
      <div class="col-sm-3">
       <h4 align="left">Quy mô</h4>
     </div>
      <div class="col-sm-3">
       <div class="form-group">
         <select class="form-control" id="exampleSelect2">
         <option>Trên 200 người</option>
         <option>dưới 100 người</option>
           <option>trên 100 người</option>
           <option>trên 300 người</option>
           <option>trên 400 người</option>
      ...
      <div class="col-sm-3">
       <h4 align="left">Sơ lược về công ty</h4>
     </div>
      <div class="col-sm-3">
      ...
      <div class="col-sm-3">
       <h4 align="left">Website</h4>
     </div>
      <div class="col-sm-3">
        <input class="form-control" placeholder="nhập www.yourcompany.com" id="inputdefault" type="text">
     </div>
      <div class="col-sm-3">
     </div>
      <br>
     ...
     <h4>Thông tin liên hệ</h4>
      ...
      <div class="col-sm-3">
       <h4 align="left">Tên người liên hệ</h4>
     </div>
      <div class="col-sm-3">
      ...
      <div class="col-sm-3">
        <input class="form-control" placeholder="nhập email" id="inputdefault" type="text">
     </div>
      <div class="col-sm-3">
     </div>
      <br>
      ...
      <div class="col-sm-3">
        <input class="form-control" placeholder="nhập số điện thoại di động" id="inputdefault" type="text">
     </div>
      <div class="col-sm-3">
     </div>
      <br>
